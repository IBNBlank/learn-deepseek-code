...
class FileTool(ToolBase):
    ...
    def tool_methods(self) -> dict[str, Callable[[dict], str]]:
        return {
            "read_file": self.read_method,
            "write_file": self.write_method,
            "edit_file": self.edit_method
        }

    def read_method(self, tool_input: dict) -> str:
    ...
    def write_method(self, tool_input: dict) -> str:
        path = tool_input["path"]
    ...
    def edit_method(self, tool_input: dict) -> str:
        path = tool_input["path"]
